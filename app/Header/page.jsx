...
const Header = () => {
    return (
        <div className="h-36 font-opensans">
            <header
                className="border-gray-200 bg-purple-main text-xl font-extrabold"
            >
                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 h-36">
                    ...
                    >
                        <ul className="font-bold flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 bg-purple-main md:bg-purple-main dark:border-gray-700">
                            <li><Link href="/">
                                <div
                                    className="block py-2 px-3 text-white hover:text-[#29b7dd] md:p-0 transition-all duration-300 hover:underline hover:underline-offset-4 hover:decoration-2 hover:decoration-[#29b7dd]"
                                >
                                    HOME
                                </div></Link>
                            </li>
